...
class PromoController {
    ...
    updatePromo = async (req: Request, res: Response) =>{
        ...
        const promo = await this.promoService.updatePromo(req.params.id, {code, discount, expiration, usageLimit, active});
        res.status(200).json(new ApiResponse(SuccessMessage.UPDATE_USER_SUCCESS, promo));
    ...
    getAllPromos = async (req: Request, res: Response) =>{
        ...
        const result = await this.promoService.getAllPromos(search as string, pageNum, limitNum);
