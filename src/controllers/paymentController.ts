...
class PaymentController {
  ...
  public getTransactionById = async (req: Request, res: Response) => {
    ...
    res
      .status(200)
      .json(new ApiResponse(SuccessMessage.GET_PAYMENT_SUCCESS, payment));
  };
  ...
  public useToken = async (req: Request, res: Response) => {
    ...
    res
      .status(200)
      .json(new ApiResponse(SuccessMessage.USE_TOKEN_SUCCESS, result));
  };
  ...
  public createPayment = async (req: Request, res: Response) => {
    ...
    return res
      .status(201)
      .json(new ApiResponse(SuccessMessage.CREATE_PAYMENT_SUCCESS, result));
  };
