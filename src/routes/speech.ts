...
router.post('/assess', uploadSingle, (req, res, next) =>
  SpeechController.assess(req, res, next)
);

// Recording
router.get('/recordings/', (req, res, next) =>
  SpeechController.listRecordings(req, res, next)
);
router.get('/recordings/:id', (req, res, next) =>
  SpeechController.detailRecording(req, res, next)
);
router.delete('/recordings/:id', (req, res, next) =>
  SpeechController.removeRecording(req, res, next)
);
